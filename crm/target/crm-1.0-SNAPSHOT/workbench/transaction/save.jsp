...
<%@ page import="java.lang.management.PlatformManagedObject" %>
...
<script type="text/javascript" src="jquery/bs_typeahead/bootstrap3-typeahead.min.js"></script>
	<script type="text/javascript">
		...
		$(function (){
			/*
			关于阶段和可能性是一种一一对应的关系，一个阶段对应一个可能性
			...
			//为阶段的下拉框，绑定选中下拉框的时间，根据选中的阶段填写可能性
			$("#create-stage").change(function (){

				var stage = $("#create-stage").val();
				//目标填写可能性，阶段有了stage，阶段和可能性之间的对应关系存在pMap中，是java语言中的map对象，但是现在在JS中
				//首先将pMap转换中js中的键值对关系json
				var possibility =json[stage];
				$("#create-possibility").val(possibility);
				/*
			    这里以json.key的形式不能取得value，因为stage是一个定义的变量，这样的key不能以json.key的形式取得，
			    要使用的取值方式为json[key]
				*/
			})
			//为保存按钮绑定事件
	...
	<form  action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="78ceee570ac3412e804d710ecaf2798e">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="8834537efc6c408a86682aba355af1f1">
			</div>
		</div>
