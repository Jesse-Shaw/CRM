...
<script type="text/javascript">
	...
	$(function(){
		...
		showActivityList();
		//为关联市场活动模态窗口中的搜索框绑定时间，通过触发回车键，查询并展现所需市场活动列表
		...
		$("#bondBtn").click(function (){
			...
			if($xz.length==0){
				...
				//workbench/clue/bond.do?clueId=xxx$activityId=xxx&activityId=xxx
...
<body>
	...
	<!-- 关联市场活动的模态窗口 -->
	<div class="modal fade" id="bondModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 80%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="bondBtn">关联</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" data-toggle="modal" data-target="#bondModal" style="text-decoration: none;"><span class="glyphicon glyphicon-plus" id="addBtn"></span>关联市场活动</a>
			</div>
		</div>
	</div>
